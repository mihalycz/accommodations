export default {
    ...
    amenities: [
        ...
        { id: 16, type: 2, name: 'garden of delight'},
        { id: 17, type: 2, name: 'floor heating'},
        { id: 18, type: 3, name: 'blender'},
        { id: 19, type: 3, name: 'dishwasher'},
        { id: 20, type: 3, name: 'coffee maker'},
        { id: 21, type: 3, name: 'freezer'},
        { id: 22, type: 3, name: 'cooking hob'},
        { id: 23, type: 3, name: 'fridge'},
        { id: 24, type: 3, name: 'golden blender'},
        { id: 25, type: 3, name: 'silver dishwasher'},
        { id: 26, type: 3, name: 'bronze coffee maker'},
        { id: 27, type: 3, name: 'mega freezer'},
        { id: 28, type: 3, name: 'strait cooking hob'},
        { id: 29, type: 3, name: 'little bit gay fridge'}
    ],
    accommodations: [
        {
            id: 1,
